...
// Создать HTML страницу, в которой будет находиться следующие элементы
//  textarea, p, button 
// Условие задачи: пользователь может вводить текст в textarea
//  По клику на кнопку текст отображается в p 
// textarea после этого ощищается
// В p ввыводится тест с учетом функции filterMessage
// использовать можно любые слова: для примера badWords = ['Собака', 'Петух', 'Козель']